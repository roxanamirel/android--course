...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		//Intent androidbrowserIntent = new Intent(ActivityLoaderActivity.this,MyBrowserActivity.class);
		...
		chooserIntent.putExtra(Intent.EXTRA_INITIAL_INTENTS, new Intent[] { baseIntent });
